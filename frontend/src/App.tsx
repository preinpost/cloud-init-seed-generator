  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-4xl">
        ...
        <footer className="text-center mt-8 text-sm text-gray-500 space-y-2">
          <p>
            Made by <span className="font-medium">@preinpost</span>
          </p>
          <p>
            <a
              href="https://github.com/preinpost/cloud-init-seed-generator"
              target="_blank"
